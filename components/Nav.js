...
export default function Nav({ show }) {
    const inactiveLink = 'flex gap-4 p-3';
    ...
    return (
        <aside className={(show ? 'left-0' : '-left-full') + " top-0 text-gray-500 p-4 fixed w-full bg-cyan-100 h-full md:static md:w-auto transition-all"}>
